...
export function FinanceVoiceHint({
  text,
  onAsk,
}: {
  text: string;
  ...
  return (
    <GlassCard blur style={styles.voiceCard}>
      <View style={styles.voiceTextWrap}>
        <Text style={styles.voiceTitle}>Ask Relay</Text>
        <Text style={styles.voiceBody}>{text}</Text>
      </View>
      <BubbleChip icon="mic" label="Voice" tone="primary" onPress={onAsk} />
    </GlassCard>
  );
}

export function FinancesTalkSheet({
  open,
  onClose,
}: {
  open: boolean;
