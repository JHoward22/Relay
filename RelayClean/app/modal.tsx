    ...
    <SafeAreaView style={styles.safeArea}>
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <GlassCard>
          ...
          <ListRow label="Using Talk to Relay" body="Voice and typing workflows" onPress={() => router.back()} />
          <ListRow label="Managing recurring reminders" body="Cadence and follow-up controls" onPress={() => router.back()} />
        ...
        <GlassCard>
          ...
          <ListRow label="Contact support" body="support@relayapp.ai" onPress={() => router.back()} />
        </GlassCard>
      </ScrollView>
    </SafeAreaView>
  );
